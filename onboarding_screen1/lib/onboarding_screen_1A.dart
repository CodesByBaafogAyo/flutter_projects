...
class Onboarding1A extends StatefulWidget {
  const Onboarding1A({Key? key}) : super(key: key);

  @override
  State<Onboarding1A> createState() => _Onboarding1AState();
}

class _Onboarding1AState extends State<Onboarding1A> {
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Onboarding1B()),
                      );
                    },
                    child: Text(
                      'Sign Up',
