...
class Onboarding2B extends StatelessWidget {
  @override
                ...
                Container(
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      minimumSize:
                          Size(160, 60), // Set the width and height as needed
                    ),
                    onPressed: () {},
                    child: Row(
                      children: [
            ...
            Container(
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      SimpleToast.showSuccessToast(context, "Success Title",
                          "Information displayed on success");
                    },
                    child: Text(
                      'Log In',
                      style: TextStyle(
